...
#ifndef _MD_LEP32X32_H__
#define _MD_LEP32X32_H__

//导入Arduino核心头文件
#include"Arduino.h"  

#define LEP_ROWS		(32)			//屏幕行数
#define LEP_COLS  	(32)			//屏幕列数
#define ROW_OCTS  	(32/8)		//每行占用字节数
...
class MdLep32X32
{
     ...
     public:
          ...
          MdLep32X32(byte sn0,byte sn1,byte sn2,byte sn3);//构造函数，填入设备号
          ~MdLep32X32();          //析构函数
