...
MdLep24X24::MdLep24X24(byte sn0,byte sn1,byte sn2,byte sn3)
{
...
void MdLep24X24::setHidden(byte flag)
{
...
void MdLep24X24::setInvert(byte flag)
{
...
void MdLep24X24::setMirror(byte flag)
{
...
void MdLep24X24::setTurn(byte flag)
{
...
void MdLep24X24::displayOn()
{
  setHidden(OPTION_ON);
}

void MdLep24X24::displayOff()
{
  setHidden(OPTION_OFF);
}

void MdLep24X24::invertOn()
{
  setInvert(OPTION_ON);
}

void MdLep24X24::invertOff()
{
  setInvert(OPTION_OFF);
}

void MdLep24X24::mirrorOn()
{
  setMirror(OPTION_ON);
}

void MdLep24X24::mirrorOff()
{
  setMirror(OPTION_OFF);
}

void MdLep24X24::turnOn()
{
  setTurn(OPTION_ON);
}

void MdLep24X24::turnOff()
{
  setTurn(OPTION_OFF);
}

void MdLep24X24::fillGram(byte val)
{
...
void MdLep24X24::setPixel(byte x, byte y,byte flag)
{
...
void MdLep24X24::drawPixel(byte x, byte y)
{
	setPixel(x, y, OPTION_ON);
}

void MdLep24X24::clearPixel(byte x, byte y)
{
	setPixel(x, y, OPTION_OFF);
}

void MdLep24X24::showASCII(byte x, byte y,byte ascii)
{
...
void MdLep24X24::loadScreen(byte logo[])
{
...
void MdLep24X24::showIcon(byte x, byte y, byte w, byte h, byte len, byte icon[])
{
